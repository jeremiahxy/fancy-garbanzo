...
const scrape = async () => {
    ...
    // let first = document.querySelector('.ysf-player-name').childNodes[0].textContent;
    // let second = document.querySelector('.ysf-player-name').childNodes[1].textContent;
    // console.log("Working?: ", first, second);
